      ...
      <Card className="w-full max-w-md bg-black/40 border-purple-500/20">
        <CardHeader className="text-center">
          <div className="flex items-center justify-center space-x-2 mb-4">
            <div className="text-3xl font-bold text-purple-400">死</div>
            <CardTitle className="text-2xl text-white">ShinigamiStream</CardTitle>
          </div>
          <CardDescription className="text-gray-300">
            Enter the realm of unlimited anime
          </CardDescription>
        </CardHeader>
        <CardContent>
